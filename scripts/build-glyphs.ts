...
const upper: Glyph[] = [
  ...
  G('S', [join([arc(500, 320, 175, 170, 60, -180, 20), arc(500, 590, 180, 175, 90, -120, 22)], 'Als een slang')]),
  G('T', [seg([[300, CAP], [700, CAP]]), seg([[500, CAP], [500, BASE]])]),
  G('U', [join([[{ x: 320, y: CAP }, { x: 320, y: 620 }], arc(500, 620, 180, 170, 180, 360, 18), [{ x: 680, y: CAP }]])]),
...
const lower: Glyph[] = [
  ...
  G('b', [seg([[330, CAP], [330, BASE]], 'Eerst de stok'), join([[{ x: 330, y: xMid - 20 }], arc(330, xMid + 15, 200, (BASE - XT) / 2 - 15, -90, 270, 28)])]),
  ...
  G('p', [seg([[330, XT], [330, DESC]], 'Stok naar beneden'), join([[{ x: 330, y: xMid - 20 }], arc(330, xMid + 15, 200, (BASE - XT) / 2 - 15, -90, 270, 28)])]),
  ...
  G('s', [join([arc(490, 470, 150, 130, 55, -170, 18), arc(490, 640, 155, 140, 90, -140, 20)])]),
  G('t', [seg([[470, 290], [470, 690]]), join([[{ x: 470, y: 690 }], arc(560, 660, 110, 110, 90, 20, 8)]), seg([[320, 400], [610, 400]])]),
  G('u', [join([[{ x: 330, y: XT }, { x: 330, y: 640 }], arc(500, 640, 170, 150, 180, 360, 16), [{ x: 670, y: XT }]]), seg([[670, 560], [670, BASE]])]),
